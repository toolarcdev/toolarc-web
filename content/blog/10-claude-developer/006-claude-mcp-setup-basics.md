...
**Q1. DesktopとCodeで設定ファイルは同じですか？**

違います。場所も書き方も製品ごとに分かれます。本記事の分岐表を優先してください。

**Q2. 設定したのに一覧に出ません。**

保存場所の取り違え、JSON構文ミス、再起動漏れが定番です。まず絶対パスと構文を確認してください。

**Q3. CursorのMCP設定と混ぜてもよいですか？**

非推奨です。Clientが違うため、[CursorのMCP設定](/blog/mcp-cursor-setup)／[VS CodeのMCP設定](/blog/mcp-vscode-setup)へ分けて進めてください。

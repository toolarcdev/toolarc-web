...
429は自分側のレート制限寄り、529はサービス側の混雑寄り、という切り分けが入口です。レスポンス内容を優先してください。

**Q2. 料金はどこで概算しますか？**

モデル×入力・出力トークンの掛け算が基本です。本文の計算枠と公式単価表を併用してください。

**Q3. キー管理の手順は？**

[APIキーと環境変数の設定](/blog/claude-api-key-env-setup)へ戻ってください。

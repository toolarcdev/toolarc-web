...
次のステップとして、[初心者のゲーム制作にJavaScriptを選ぶ6つの理由](/blog/why-javascript-for-game-dev)で、なぜJavaScriptがゲーム制作の入門に向いているのかを整理しています。学習の順番に迷う人は、[初心者向けゲーム制作の学習ロードマップ5選](/blog/game-dev-roadmap-comparison)もあわせてどうぞ。シリーズ全体の流れは、入口となるまとめ記事でも確認できます（準備中）。

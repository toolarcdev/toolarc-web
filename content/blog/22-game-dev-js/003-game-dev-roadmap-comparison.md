...
ロードマップ①を選んだ場合の次の一歩は、3か月の具体的な学習スケジュールを立てることです。詳しいスケジュールの組み方は、シリーズの別記事（準備中）で扱っています。公開後にどう学びを続けていくかについても、別記事（準備中）で取り上げる予定です。シリーズ全体の入口となるまとめ記事も、準備が整い次第公開します。

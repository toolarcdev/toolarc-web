...
まずは`console.log()`で文字や数字を表示するところから始めます。地味に感じるかもしれませんが、「書いたコードが画面に反映される」感覚を掴む段階です。
...
本記事の内容は執筆時点（2026-08-09）の情報に基づきます。エディタや拡張機能マーケットプレイスの仕様は変更される可能性があります。学習の進み方には個人差があるため、週数はあくまで目安として捉えてください。重要な判断は公式ドキュメントで確認することをおすすめします。

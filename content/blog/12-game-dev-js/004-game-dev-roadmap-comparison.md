...
ロードマップ①を選んだ場合の次の一歩は、3か月の具体的な学習スケジュールを立てることです。詳しいスケジュールの組み方は、[ゲーム制作JavaScript学習｜1か月目のスケジュールと進め方](/blog/game-dev-schedule-month1)と[ゲーム制作JavaScript学習｜2か月目のスケジュールと進め方](/blog/game-dev-schedule-month2)で扱っています。公開後にどう学びを続けていくかについても、別記事（準備中）で取り上げる予定です。シリーズ全体の流れは、[初心者のゲーム制作で学ぶプログラミング｜3か月ロードマップ](/blog/game-dev-roadmap)でも確認できます。

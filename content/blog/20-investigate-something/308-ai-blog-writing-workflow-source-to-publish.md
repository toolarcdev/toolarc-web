...
[無料セミナーでAI記事作成の学習順を確認する](affiliate:ai-skill-academy:text-main:cta)
...
設計（source.md）は自分で固めたうえで、**初稿のたたき台だけを短縮したい**場合は、下書き特化ツールという分岐もあります。向き不向きは記事末の判断ブロックで確認してください。

[Rakurinで初稿のたたき台を試す](affiliate:rakurin:text:cta)
...
学びの順番ではなく、**Step2の初稿工程をツールで短縮したいかどうか**で判断します。source.mdで読者・結論を固めたうえで、たたき台だけを早く欲しい人向けです。

**向く人**
- 設計（source.md）は自分で書けるが、初稿のたたき台作成に時間がかかっている人
- Claude/ChatGPTのチャット運用より、下書き特化ツールの画面で試したい人
- 無料枠や無料プランの範囲で、まず運用感を比較したい人

**向かない人**
- まだ読者像・結論が決まっておらず、学ぶ順番そのものから整理したい人（その場合は上の無料セミナー分岐）
- 文章の最終品質までツールに任せたい人（公開前レビューは人間が必要）
- すでにClaude等での初稿フローが安定している人

**注意点と代替案**
- 料金・プラン・無料枠は変更されることがあるため、契約前に公式情報を確認してください
- Rakurinは本記事フローの「代替」であり、source.md設計と人間レビューを省略するものではありません

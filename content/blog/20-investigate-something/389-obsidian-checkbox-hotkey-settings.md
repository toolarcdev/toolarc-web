...
IMEとの兼ね合いで発生する入力トラブル全般は範囲が広いため、本記事では扱いません。切り分けの手順は[/blog/obsidian-shortcut-ime](/blog/obsidian-shortcut-ime)で扱っています。ここでは「チェックのトグルが効かない一因としてIMEの状態がある」という切り分けの入口だけを押さえておきます。

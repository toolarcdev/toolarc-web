---
title: "Obsidianの文字サイズ変更｜テーマはそのままCSS1行"
description: "Obsidianの文字サイズ・フォントサイズを、テーマ全体を変えずに調整したい初心者向け。CSSスニペットへfont-sizeを1行追加する手順と、効かないときのセレクタの絞り方を、Windows版で確認した範囲でまとめました。"
date: 2026-07-26
tags:
  - Obsidian
  - CSSスニペット

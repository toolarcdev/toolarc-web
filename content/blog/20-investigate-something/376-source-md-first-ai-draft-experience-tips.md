...
description: "ChatGPTやClaudeに丸投げして直しが増えていた運用を、source.mdで読者・結論・構成を先に固める形へ変更した実測体験です。何が変わったか、向く人／向かない人、次に読む手順記事まで整理します。"
date: 2026-07-20
tags:
  - source.md
  - AIブログ
...
本記事は手順の網羅ではなく、**source.mdを先に書く運用へ変えたあとの実測体験**に絞ります。型そのものの手順は、記事末で本命のフロー記事へ接続します。

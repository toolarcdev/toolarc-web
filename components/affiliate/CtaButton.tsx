...
export function CtaButton({
  ...
  return (
    <a
      ...
      href={href}
      onClick={onClick}
      className={`mx-auto my-6 flex w-full max-w-xl items-center justify-center rounded-lg px-5 py-3.5 text-center text-sm font-semibold leading-6 text-pretty transition-colors ${VARIANT_CLASS[variant]}`}
    >
      {children}
    </a>
  );

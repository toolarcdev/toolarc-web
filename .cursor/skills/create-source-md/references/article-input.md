...
- 内部リンク候補:
- 深さの上限・やらないこと（戦略）:
- ペルソナ（任意・案。1〜3人でよい。確定ではない。経験・迷い・検索着地の状況で書く。他記事／Hub既読を軸にしない）:
- 記事の仕事（任意・案。確定ではない）:
...
- **他記事既読を軸にしない**（writing-rules「他記事既読を前提にしない」）。ペルソナ案は経験・迷い・検索着地の状況で書く。例として不採用: 「前の手順記事を読んだ人」「Hubの地図だけ見た人」「シリーズを読んだ人向け」。隣記事境界・読む順は必須の分担メモであり、読者像の軸にしない
...
- **他記事／Hub既読を軸にしたペルソナ案**（上「任意の扱い」。案であっても書かない）

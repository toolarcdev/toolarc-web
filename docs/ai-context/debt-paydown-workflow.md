...
| Hub と `series.ts` の差分 **≥3本** | 赤 | 次の①依頼を Hub 更新（P0）に切替 |
| `20` 総数 **≥35本** | 黄 | **48時間以内**に①を整理 PR（P0/P1）へ1回差し替え。公開は継続可 |
| `20` 総数 **≥40本** | 赤 | **翌日の新規3本公開をスキップ**し、整理 PR を優先 |
| 週次純増 **≥+10本** | 赤 | 赤相当（水曜待たず整理①） |
| 単発確定（シリーズ化予定なし） | — | 公開時に `standalone`。昇格キューに入れない |

**運用注釈**

- 現ペース（日次 +3本 × 週7日 ≒ **+21本/週**）では、P1 後の定常値は **34本前後**
- 旧 **≥30** は設計当初の目安。現運用では到達困難のため廃止

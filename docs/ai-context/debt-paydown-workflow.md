...
| **debt カウンタ** | Dashboard のシリーズ負債カウンタ3行を更新 |
...
| 条件 | アクション |
|------|-----------|
| 同一シリーズが `20` に **5本** 滞留 | 翌公開日までに昇格 PR（P1） |
| Hub と `series.ts` の差分 **≥3本** | 次の①依頼を Hub 更新（P0）に切替 |
| `20` 総数 **≥30本** | 新規公開を1日休み、整理 PR 優先 |
